...
class Listing(models.Model):
    ...
    def clean(self):
        ...
        """Model-level validation — runs via admin. ListingForm handles web form validation."""
    ...
    def save(self, *args, **kwargs):
        ...
        # FIX 1: Removed self.full_clean() — breaks Cloudinary image uploads (500 error).

        # FIX 3: is_taken deletion is now handled in the view, not here.

        # This method is now a clean, simple save.
...
class LandlordProfile(models.Model):
    ...
    # Auto-generated unique Landlord ID e.g. DH-AB1234

    landlord_id = models.CharField(max_length=12, unique=True, blank=True, null=True,

        help_text="System-generated landlord ID (e.g. DH-AB1234)")
    ...
    def __str__(self):
        ...
        return f"{self.user.username} ({self.landlord_id or 'No ID'}) Landlord Profile"
    ...
    def generate_landlord_id():
        ...
        """Generate a unique ID: DH-XX9999 (2 letters + 4 digits). Retries until unique."""
        ...
        while True:
            ...
            new_id = f"DH-{letters}{digits}"

            if not LandlordProfile.objects.filter(landlord_id=new_id).exists():
...
class Message(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # FIX 1: Removed self.full_clean() — MessageForm already validates everything.
